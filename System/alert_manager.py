...
class Alert_Manager:
    ...
    def __init__(self, update_mode):
        print("Alert_Manager Init Started")
        ...
        print("Alert_Manager Init Completed")
    ...
    def __Alert_Manager(self):
        print("Alert_Manager Thread Started")
        ...
        while True:
            if self.__alert_queue.empty() != True:
                ...
                if __alert_item[0] == "alert":
                    print("Set Alaram")
                    print("Send Alert To Telegram" + __alert_item[1])
                elif __alert_item[0] == "warning":
                    print("Send Warning To Telegram" + __alert_item[1])    
            ...
            if self.__alert_handle_queue.empty() != True:
                ...
                if __alert_handle_item[0] == "reset":
                    ...
                    print("Send Reset Response To Telegram")
                elif __alert_handle_item[0] == "changeMode":
                    self.__update_mode(__alert_handle_item[1])
                    print("Send changeMode Response To Telegram" + __alert_handle_item[1])  
