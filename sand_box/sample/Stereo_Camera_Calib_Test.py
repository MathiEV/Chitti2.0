...
for i in range(0,50):   # Put the amount of pictures you have taken for the calibration inbetween range(0,?) wenn starting from the image number 0
    t= str(i)
    ChessImaR= cv2.imread('./Images/StereoRight30/imgR'+t+'.png',0)    # Right side
    ChessImaL= cv2.imread('./Images/StereoLeft30/imgL'+t+'.png',0)    # Left side
...
##    dispR= cv2.resize(disp,None,fx=0.7, fy=0.7, interpolation = cv2.INTER_AREA)
    ...
    # Mouse click
    cv2.setMouseCallback("Filtered Color Depth",coords_mouse_disp)
